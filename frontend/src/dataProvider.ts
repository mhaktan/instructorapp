...
const RESOURCE_CONFIG: Record<string, ResourceConfig> = {
  'Instructor': { path: 'api/services/app/Instructor', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Member': { path: 'api/services/app/Member', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'MemberInstructor': { path: 'api/services/app/MemberInstructor', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Lesson': { path: 'api/services/app/Lesson', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'LessonAttendance': { path: 'api/services/app/LessonAttendance', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
  'Payment': { path: 'api/services/app/Payment', paginationStyle: 'offset-limit', pageParam: 'SkipCount', sizeParam: 'MaxResultCount', sortStyle: 'combined', sortParam: 'Sorting', filterStyle: 'search', searchParam: 'Keyword', abpStyle: true },
