...
import { MemberInstructorList } from './MemberInstructorList';
...
describe('MemberInstructorList', () => {
  it('should render without crashing', () => {
    const { container } = render(<MemberInstructorList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<MemberInstructorList />, { wrapper });
    expect(screen.getByText('MemberInstructor')).toBeDefined();
  });

  it('should have create button', () => {
    render(<MemberInstructorList />, { wrapper });
    expect(screen.getByText('+ Create MemberInstructor')).toBeDefined();
  });
