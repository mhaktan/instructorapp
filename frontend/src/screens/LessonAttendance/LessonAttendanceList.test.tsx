...
import { LessonAttendanceList } from './LessonAttendanceList';
...
describe('LessonAttendanceList', () => {
  it('should render without crashing', () => {
    const { container } = render(<LessonAttendanceList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<LessonAttendanceList />, { wrapper });
    expect(screen.getByText('LessonAttendance')).toBeDefined();
  });

  it('should have create button', () => {
    render(<LessonAttendanceList />, { wrapper });
    expect(screen.getByText('+ Create LessonAttendance')).toBeDefined();
  });
