...
namespace InstructorApp.Web.Host
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "InstructorApp API", Version = "v1" });
            ...
            return services.AddAbp<InstructorAppWebHostModule>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "InstructorApp API V1");
            });
